document.addEventListener('DOMContentLoaded', function() {
  ...
  // Dynamically load hero-donate script to enable hero slider and donate modal
  var _hd = document.createElement('script');
  _hd.src = 'js/hero-donate.js';
  _hd.async = true;
  document.body.appendChild(_hd);
});
